...
from .voxelize import VoxelizationByGridShapeDet
...
class Det3DDataPreprocessor_cylinder_fusion(DetDataPreprocessor):
    ...
    def __init__(self,
        ...
        super(Det3DDataPreprocessor_cylinder_fusion, self).__init__(
            mean=mean,
            std=std,
        ...
        self.max_voxels = max_voxels
        if voxel:
            self.voxel_layer = VoxelizationByGridShapeDet(**voxel_layer)
